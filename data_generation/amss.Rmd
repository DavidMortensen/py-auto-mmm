...
sim.data <- SimulateAMSS(
  ...
  media.names = c("tv","ooh","print","facebook","search"),
  media.modules = c(
    ...
    `DefaultSearchMediaModule`),
  media.params = list(params.tv ,params.ooh,params.print ,params.facebook,params.search),
